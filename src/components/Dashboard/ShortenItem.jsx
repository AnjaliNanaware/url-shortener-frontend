...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const fetchMyShortUrl = async () => {
       ...
       const formattedStartDate = formatToCustomDateTime(oneYearAgoDate);

        // Format end date to the end of the current day
        // To get 23:59:59 for the end date:
        const endDate = new Date(currentDate); // Start with current date
        endDate.setHours(23, 59, 59, 999); // Set to end of day, milliseconds for precision
        const formattedEndDate = formatToCustomDateTime(endDate);
        try {
